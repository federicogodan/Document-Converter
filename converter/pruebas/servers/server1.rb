...
Thread.start do
	...
	Thread.start do
	  ...
	  File.open('/home/ubuntu/pruebas/temp1/'+ name, 'w') do |file|
	  ...
	  #TODO: put a relative path instead of '/home/mika'
	  to_send = '/home/ubuntu/LibreOffice_4.1.2.3_Linux_x86_rpm/RPMS/install1/opt/libreoffice4.1/program/soffice --headless --invisible --convert-to ' + format + plus + ' /home/ubuntu/pruebas/temp1/'+ name
