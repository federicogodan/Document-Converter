...
ActiveRecord::Schema.define(:version => 20131119020912) do
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "api_key"
    t.string   "secret_key"
    t.integer  "total_storage_assigned",        :default => 1234, :null => false
    t.integer  "documents_time_for_expiration", :default => 123,  :null => false
    t.integer  "bandwidth_in_bytes_per_sec",    :default => 0,    :null => false
    t.integer  "max_document_size",             :default => 1243, :null => false
    t.datetime "created_at",                                      :null => false
    t.datetime "updated_at",                                      :null => false
  end
